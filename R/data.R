...
#'
#' A dataset, which come from a study by Stamey et al. (1989), examining the correlation between the level of prostate-specific
#' antigen (PSA) and various clinical measures in men who were about the receive
